...
date: 2025-05-29
thumbnail: assets/img/press/bsa_eco_anxiety_hero.jpg
archived_pdf: /assets/pdf/press/2025-05-29-bsa-navigating-eco-anxiety.pdf
excerpt: A guest piece I wrote for the British Science Association during Mental Health Awareness Month 2025, on eco-anxiety and how to keep doing climate work without burning out.
featured_order: 1
---
...
{%
  ...
  loading="eager"
  path="assets/img/press/bsa_eco_anxiety_hero.jpg"
  alt="Navigating eco-anxiety in the face of the climate crisis"
  class="img-fluid rounded mb-4"
%}

<p class="text-muted">
  <strong>{{ page.source }}</strong> &middot; {{ page.date | date: "%-d %B %Y" }} &middot; <em>Authored guest piece</em>
</p>
...
<div class="alert alert-light border mt-4 small" style="background-color: rgba(0,0,0,0.03);">
  ...
  and <a href="https://www.mind.org.uk" target="_blank" rel="noopener">Mind</a> offer free, confidential support.
</div>

---
layout: page
title: "Featured in The Wheel: Advancing Polar Research"
source: St Catharine's College, University of Cambridge — The Wheel 2022 (College magazine)
source_url: https://www.caths.cam.ac.uk/alumni-friends/alumni-community/publications/wheel
date: 2022-06-01
thumbnail: assets/img/press/wheel_2022_cover.jpg
archived_pdf: /assets/pdf/press/St_Catharines_Wheel_2022.pdf
excerpt: A profile in the 2022 edition of The Wheel, St Catharine's College's annual magazine, as part of a feature on St Catharine's polar research community.
---
...
<div class="row align-items-start g-4 mb-4">
  <div class="col-md-4">
    {%
      ...
      loading="eager"
      path="assets/img/press/wheel_2022_cover.jpg"
      alt="The Wheel 2022 — St Catharine's College magazine cover"
  ...
  <div class="col-md-8">
    ...
    <p>
      <em>The Wheel</em> is St Catharine's College's annual print magazine, sent to alumni and friends of the College each year. The 2022 edition includes a two-page feature on <strong>"Advancing polar research"</strong>, profiling three members of the St Catharine's polar community — and I was honoured to be one of them, alongside Professor David Aldridge (on Antarctic biosecurity) and my MPhil supervisor Professor Ian Willis (on ice shelf dynamics).
    </p>
  </div>
</div>
...
The Wheel pointed readers to the longer Polar Impact feature published earlier on the College website — included separately on this site as [Amplifying Diversity in Polar Exploration]({% link _press/2021-11-22-cambridge-catz-polar-impact.md %}).
...
{%
  include figure.liquid
  loading="lazy"
  path="assets/img/press/wheel_2022_page4.jpg"
  alt="The Wheel 2022 — page 4: Advancing polar research"
  class="img-fluid rounded border my-3"
%}

---

- 📄 **Download the magazine** ([4.4 MB PDF, see page 4]({{ page.archived_pdf | relative_url }}))
- 🔗 **Browse other Wheel editions:** [caths.cam.ac.uk → publications]({{ page.source_url }})

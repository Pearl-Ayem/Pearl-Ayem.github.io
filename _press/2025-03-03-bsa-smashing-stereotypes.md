...
date: 2025-03-03
thumbnail: assets/img/press/bsa_smashing_promo.jpg
archived_pdf: /assets/pdf/press/2025-03-03-bsa-smashing-stereotypes.pdf
video_url: https://www.youtube.com/embed/I8XIvsLGfIc
excerpt: A profile in the British Science Association's Smashing Stereotypes campaign on my work as a climate scientist and risk modeller, and on combating gender stereotypes in STEM.
featured_order: 3
---
...
{%
  ...
  loading="eager"
  path="assets/img/press/bsa_smashing_promo.jpg"
  alt="Smashing Stereotypes: Pearl Ayem — Physical climate scientist"
...
<div class="my-5" style="position: relative; width: 100vw; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw;">
  <div class="text-center px-3">
    <h2 class="mb-4">Watch the full interview</h2>
    <div class="ratio ratio-16x9 mx-auto" style="max-width: 1400px;">
      <iframe
        src="{{ page.video_url }}"
...
{%
  include figure.liquid
  loading="lazy"
  path="assets/img/press/bsa_maps_colleague.jpg"
  alt="Pearl reviewing climate risk maps with a colleague"
...
{%
  include figure.liquid
  loading="lazy"
  path="assets/img/press/bsa_seated_bw.jpg"
  alt="Pearl in a quiet, reflective moment"
  class="img-fluid rounded my-4"
%}
...
{%
  include figure.liquid
  loading="lazy"
  path="assets/img/press/bsa_balcony.jpg"
  alt="Pearl on a wooden balcony, smiling down"
  class="img-fluid rounded my-4"
%}
...
{%
  include figure.liquid
  loading="lazy"
  path="assets/img/press/bsa_yellow_chair.jpg"
  alt="Pearl seated on a yellow chair, on a colourful patterned rug"
  class="img-fluid rounded my-4"
%}
...
- 🔗 **Read the full feature:** [britishscienceweek.org → Smashing Stereotypes: Pearl Ayem]({{ page.source_url }})

...
date: 2024-11-07
thumbnail: assets/img/press/chartis_cliamte_risk_all_speakers.jpg
video_url: https://www.youtube.com/embed/KVrza3X86Cg
excerpt: A keynote panel for Chartis Research's launch of ClimateRisk50 2024, covering how climate risk modelling impacts banking portfolios — with Namish Sharma (HSBC) and moderated by Sid Dash (Chartis).
featured_order: 2
---
...
{%
  ...
  loading="eager"
  path="assets/img/press/chartis_cliamte_risk_all_speakers.jpg"
  alt="Chartis ClimateRisk50 2024 keynote panel speakers"
  class="img-fluid rounded mb-4"
%}

<p class="text-muted">
  <strong>{{ page.source }}</strong> &middot; {{ page.date | date: "%-d %B %Y" }} &middot; <em>Keynote panel</em>
</p>
...
<div class="my-5" style="position: relative; width: 100vw; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw;">
  <div class="text-center px-3">
    <h2 class="mb-4">Watch the full panel</h2>
    <div class="ratio ratio-16x9 mx-auto" style="max-width: 1400px;">
      <iframe
        src="{{ page.video_url }}"
        title="Chartis ClimateRisk50 2024 — Banking Panel"
...
- 🔗 **About the report:** [chartis-research.com → ClimateRisk50 2024]({{ page.source_url }})
